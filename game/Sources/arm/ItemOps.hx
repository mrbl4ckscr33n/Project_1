...
class ItemOps // static
{
	public static function pushItems(ncs_1: NewCanvasScript, canvas_1: Tcanvas,  rigidToPush: RigidBody): Bool // returns if container is full
	{
		...
		asset_0.file = rigidToPush.object.name.toLowerCase();
	...
	public static function pushElements(ncs_1: NewCanvasScript, canvas_1: Tcanvas, element_0: Telement, asset_0: Tasset = null): Void
	{
		...
		if(asset_0 != null)
		{
			/*for(a in 0...10)
			{
				if(iron.data.Data.cachedImages["inventory_background.png"] != null)
				{
					trace("inventory_background");
					iron.data.Data.deleteImage("inventory_background.png");
				}
			}*/

			iron.data.Data.getImage(asset_0.file + ".png", function(image: kha.Image)
			{
